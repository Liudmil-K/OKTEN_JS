...
for (const simpson of simpsons) {
    ...
    hName.innerText = simpson.name;
    hSurname.innerText = simpson.surname;
    pAge.innerText = simpson.age;
    pInfo.innerText = simpson.info;
    imgPhoto.src = simpson.photo;

    divElement.appendChild (hName);
    divElement.appendChild (hSurname);
    divElement.appendChild (pAge);
    divElement.appendChild (pInfo);
    divElement.appendChild (imgPhoto);
    document.body.appendChild (divElement);
}

// - Є масив Створити для кожного елементу масиву свій блок, блок розділити блоками, в яких будуть зберігатись значення окремих властивостей, для властивості modules зробити список з елементами
